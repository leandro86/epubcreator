...
from pyepubwriter import epub, opf, toc
...
class TestEpubGeneration(unittest.TestCase):
    ...
    def testOpfManifestAndSpineWithHtmls(self):                      
        ...
        self.assertEqual(len(self._xpath(opf, "/opf:package/opf:manifest/opf:item[@href = 'toc.ncx' and @id = 'ncx' and @media-type = 'application/x-dtbncx+xml']")), 1)
        self.assertEqual(len(self._xpath(opf, "/opf:package/opf:manifest/opf:item[@href = 'Text/Section0000.xhtml' and @id = 'Section0000.xhtml' and @media-type = 'application/xhtml+xml']")), 1)
        self.assertEqual(len(self._xpath(opf, "/opf:package/opf:manifest/opf:item[@href = 'Text/Section0001.xhtml' and @id = 'Section0001.xhtml' and @media-type = 'application/xhtml+xml']")), 1)
    ...
    def testOpfMetadata(self):
        ...
        self.assertEqual(self._xpath(opf, "/opf:package/opf:metadata/dc:date[@opf:event = 'modification']/text()"), [datetime.datetime.now().strftime("%Y-%m-%d")])
        self.assertEqual(self._xpath(opf, "/opf:package/opf:metadata/dc:date[@opf:event = 'publication']/text()"), ["2013-05-09"])
        ...
        self.assertEqual(self._xpath(opf, "/opf:package/opf:metadata/dc:description/text()"), ["Esta es la descripción del ebook."])
        self.assertEqual(self._xpath(opf, "/opf:package/opf:metadata/dc:contributor[@opf:role = 'trl' and @opf:file-as = 'Poe, Edgar Allan']/text()"), ["Edgar Allan Poe"])
        self.assertEqual(self._xpath(opf, "/opf:package/opf:metadata/dc:creator[@opf:role = 'aut' and @opf:file-as = 'Borges, Jorge Luis']/text()"), ["Jorge Luis Borges"])
        self.assertEqual(self._xpath(opf, "/opf:package/opf:metadata/dc:contributor[@opf:role = 'ill' and @opf:file-as = 'Van Gogh, Vincent']/text()"), ["Vincent Van Gogh"])
    ...
    def testTocNavPointsNesting(self):
        ...
        self.assertEqual(len(self._xpath(toc, "/toc:ncx/toc:navMap/toc:navPoint[@id = 'navPoint-1']/toc:navPoint[@id = 'navPoint-2' and @playOrder = '2']")), 1)
        self.assertEqual(len(self._xpath(toc, "/toc:ncx/toc:navMap/toc:navPoint[@id = 'navPoint-1']/toc:navPoint[@id = 'navPoint-3' and @playOrder = '3']")), 1)
        
        self.assertEqual(len(self._xpath(toc, "/toc:ncx/toc:navMap/toc:navPoint[@id = 'navPoint-4' and @playOrder = '4']")), 1)
        self.assertEqual(len(self._xpath(toc, "/toc:ncx/toc:navMap/toc:navPoint[@id = 'navPoint-4']/toc:navPoint[@id = 'navPoint-5' and @playOrder = '5']")), 1)
        self.assertEqual(len(self._xpath(toc, "/toc:ncx/toc:navMap//toc:navPoint[@id = 'navPoint-5']/toc:navPoint[@id = 'navPoint-6' and @playOrder = '6']")), 1)
        self.assertEqual(len(self._xpath(toc, "/toc:ncx//toc:navPoint[@id = 'navPoint-6']/toc:navPoint[@id = 'navPoint-7' and @playOrder = '7']")), 1)

        self.assertEqual(len(self._xpath(toc, "/toc:ncx/toc:navMap/toc:navPoint[@id = 'navPoint-8' and @playOrder = '8']")), 1)
        self.assertEqual(len(self._xpath(toc, "/toc:ncx/toc:navMap/toc:navPoint[@id = 'navPoint-8']/toc:navPoint[@id = 'navPoint-9' and @playOrder = '9']")), 1)
        self.assertEqual(len(self._xpath(toc, "/toc:ncx/toc:navMap//toc:navPoint[@id = 'navPoint-9']/toc:navPoint[@id = 'navPoint-10' and @playOrder = '10']")), 1)
    ...
    def testAddingImagesAndCss(self):
        ...
        self.assertEqual(len(self._xpath(opf, "/opf:package/opf:manifest/opf:item[@href = 'Images/image1.jpg' and @id = 'image1.jpg' and @media-type = 'image/jpeg']")), 1)
        self.assertEqual(len(self._xpath(opf, "/opf:package/opf:manifest/opf:item[@href = 'Images/image2.jpg' and @id = 'image2.jpg' and @media-type = 'image/jpeg']")), 1)
        self.assertEqual(len(self._xpath(opf, "/opf:package/opf:manifest/opf:item[@href = 'Images/image3.png' and @id = 'image3.png' and @media-type = 'image/png']")), 1)
        self.assertEqual(len(self._xpath(opf, "/opf:package/opf:manifest/opf:item[@href = 'Images/image4.png' and @id = 'image4.png' and @media-type = 'image/png']")), 1)
        self.assertEqual(len(self._xpath(opf, "/opf:package/opf:manifest/opf:item[@href = 'Styles/style.css' and @id = 'style.css' and @media-type = 'text/css']")), 1)
    ...
    def testOpfGuide(self):
        ...
        self.assertEqual(len(self._xpath(opf, "/opf:package/opf:guide/opf:reference[@href = 'Text/cubierta.xhtml' and @title = 'Cover' and @type = 'cover']")), 1)
